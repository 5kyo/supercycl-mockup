...
const MOCK_ACTIVITY = [
  { text: "Opened XRPUSDT Short · 2x", time: "2h ago" },
  { text: "Opened BTCUSDT Long · 2x", time: "3h ago" },
  { text: "Deposited 100 USDC", time: "5h ago" },
] as const;
...
export default function PortfolioPage() {
  ...
  return (
    <div style={section}>
      ...
      {/* Recent Activity */}
      <div style={card}>
        <div style={{ ...label, marginBottom: "8px" }}>Recent Activity</div>
        {MOCK_ACTIVITY.map((a) => (
          <div key={a.text} style={{
            ...
            <span style={{ fontSize: "11px", color: "#9f9f9f" }}>{a.text}</span>
            <span style={{ fontSize: "10px", color: "#505050" }}>{a.time}</span>
          </div>
        ))}
      </div>
    </div>
